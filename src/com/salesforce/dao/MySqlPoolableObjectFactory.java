	...
	public static void init() throws Exception {
		...
		try{
			...
			if( pool==null && datasource==null){
				...
				pool.setUrl(SalesForceEnvironment.getDBURL());
				pool.setDriverClassName(SalesForceEnvironment.getMYSQLDriver());
				pool.setUsername(SalesForceEnvironment.getDBUser());
				pool.setPassword(SalesForceEnvironment.getDBPwd());
				...
				SalesForceEnvironment.setComment(3,className," ConPool Datasource formed "+datasource);
		}
			
		}catch(Exception e){
			SalesForceEnvironment.setComment(1,className," Exception in Datasource formation "+e.getMessage());
	...
	public static Connection getConnection() throws Exception {
		...
		try{
			conn = datasource.getConnection();
				...
				SalesForceEnvironment.setComment(1,className," Can't get connection "+e.getMessage());
			}

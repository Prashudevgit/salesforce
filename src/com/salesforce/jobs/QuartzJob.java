...
public class QuartzJob implements Job{
    ...
    public QuartzJob() {
    	...
    	if(isInstance == false) {
    		SalesForceEnvironment.setComment(3,className,"============== inside the QuartzJob First Time:" +className + " at "+java.time.LocalTime.now()+"isInstance "+isInstance);
	    	try {
				Thread.sleep(1000);
				isInstance = true;
